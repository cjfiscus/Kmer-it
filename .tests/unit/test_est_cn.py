...
def test_est_cn(conda_prefix):

    with tempfile.TemporaryDirectory() as tmpdir:
        workdir = Path(tmpdir) / "workdir"
        config_path = Path(".tests/unit/est_cn/config")
        data_path = Path(".tests/unit/est_cn/data")
        expected_path = Path(".tests/unit/est_cn/expected")
