...
def test_map_to_organelle_genomes_pe(conda_prefix):

    with tempfile.TemporaryDirectory() as tmpdir:
        workdir = Path(tmpdir) / "workdir"
        config_path = Path(".tests/unit/map_to_organelle_genomes_pe/config")
        data_path = Path(".tests/unit/map_to_organelle_genomes_pe/data")
        expected_path = Path(".tests/unit/map_to_organelle_genomes_pe/expected")
