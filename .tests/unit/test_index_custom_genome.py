...
def test_index_custom_genome(conda_prefix):

    with tempfile.TemporaryDirectory() as tmpdir:
        workdir = Path(tmpdir) / "workdir"
        config_path = Path(".tests/unit/index_custom_genome/config")
        data_path = Path(".tests/unit/index_custom_genome/data")
        expected_path = Path(".tests/unit/index_custom_genome/expected")
        ...
        check_output(
            [
                ...
                "resources/org_genomes.fa.amb",
                "resources/org_genomes.fa.ann",
                "resources/org_genomes.fa.bwt",
                "resources/org_genomes.fa.pac",
                "resources/org_genomes.fa.sa",
                "--snakefile",
                "workflow/Snakefile",
                "-f",
                "--notemp",
