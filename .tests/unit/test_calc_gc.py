...
def test_calc_gc(conda_prefix):

    with tempfile.TemporaryDirectory() as tmpdir:
        workdir = Path(tmpdir) / "workdir"
        config_path = Path(".tests/unit/calc_gc/config")
        data_path = Path(".tests/unit/calc_gc/data")
        expected_path = Path(".tests/unit/calc_gc/expected")
