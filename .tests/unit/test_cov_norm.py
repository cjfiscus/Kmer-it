...
def test_cov_norm(conda_prefix):

    with tempfile.TemporaryDirectory() as tmpdir:
        workdir = Path(tmpdir) / "workdir"
        config_path = Path(".tests/unit/cov_norm/config")
        data_path = Path(".tests/unit/cov_norm/data")
        expected_path = Path(".tests/unit/cov_norm/expected")
